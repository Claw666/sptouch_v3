/*Bus departure times in minutes (e.g. 17:15 -> 17*60+15) */
  ...
  function refreshDiv(){
    ...
    if ((document.getElementById("soton_soton") !== null) && (document.getElementById("soton_chil") !== null) && (document.getElementById("rom_chil") !== null) && (document.getElementById("rom_soton")!== null)){
    ...
    if (currentTimeInMin < 420 || currentTimeInMin >= 1080){
    ...
    if (currentTimeInMin < 420 || currentTimeInMin >= 1056){
